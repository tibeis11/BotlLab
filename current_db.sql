...
CREATE TABLE IF NOT EXISTS "public"."ratings" (
    ...
    "plausibility_score" numeric DEFAULT 1.0,
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "botlguide_insights_enabled" boolean DEFAULT true NOT NULL,
...
CREATE INDEX "idx_botlguide_feedback_user_capability" ON "public"."botlguide_feedback" USING "btree" ("user_id", "capability");
...
CREATE INDEX "idx_ratings_shadowban" ON "public"."ratings" USING "btree" ("is_shadowbanned") WHERE ("is_shadowbanned" = true);
...
CREATE INDEX "idx_tse_shadowban" ON "public"."tasting_score_events" USING "btree" ("is_shadowbanned") WHERE ("is_shadowbanned" = true);
...
ALTER TABLE ONLY "public"."analytics_ai_insights"
    ADD CONSTRAINT "analytics_ai_insights_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "public"."brewing_sessions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."analytics_ai_insights"
    ADD CONSTRAINT "analytics_ai_insights_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Users can read own feedback" ON "public"."botlguide_feedback" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
