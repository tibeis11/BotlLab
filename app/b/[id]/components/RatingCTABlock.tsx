        ...
        <div className="shrink-0">
          {capCollected ? (
            <Link
              ...
              className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest text-brand border border-brand-dim rounded-xl px-3 py-2 hover:bg-brand-bg/20 transition whitespace-nowrap"
            >
              ✨ Ansehen
            </Link>
          ) : hasAlreadyRated ? (
            <button
              ...
              className="inline-flex items-center gap-1.5 bg-brand hover:bg-brand-hover active:scale-95 text-black font-black text-xs rounded-xl px-4 py-2.5 transition-all disabled:opacity-50 whitespace-nowrap"
            >
              {collectingCap ? (
            ...
            <button
              onClick={onRate}
              className="inline-flex items-center gap-1.5 bg-white hover:bg-brand-hover active:scale-95 text-black font-black text-xs rounded-xl px-4 py-2.5 transition-all whitespace-nowrap"
            >
              💬 Bewerten
            </button>
          )}
