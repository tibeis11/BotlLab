  ...
  return (
    <div className="min-h-screen bg-background text-text-secondary">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <Link href="/" className="inline-flex items-center gap-2 text-brand hover:text-brand-hover font-bold mb-12 transition">
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-4">Angaben gemäß § 5 TMG</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-4">Kontakt</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-4">Redaktionell verantwortlich</h2>
            <p>
              {editorial.name}<br />
              {editorial.street}<br />
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-4">EU-Streitschlichtung</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-text-primary mb-4">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h2>
            <p>
          ...
          <section className="text-sm text-text-muted">
            <h2 className="text-lg font-bold text-text-primary mb-4">Haftungsausschluss (Disclaimer)</h2>
            
            <h3 className="font-bold text-text-primary mt-4 mb-2">Haftung für Inhalte</h3>
            <p>
            ...
            <h3 className="font-bold text-text-primary mt-4 mb-2">Haftung für Links</h3>
            <p>
            ...
            <h3 className="font-bold text-text-primary mt-4 mb-2">Urheberrecht</h3>
            <p>
