...
export default function ClientBrewPage({ initialData, initialError, initialUser }: { initialData: any; initialError: string | null; initialUser: any }) {
  const params = useParams();
  const router = useRouter();
  const searchParams = useSearchParams();
  const id = params.id as string;

  const [brew, setBrew] = useState<any>(initialData || null);
