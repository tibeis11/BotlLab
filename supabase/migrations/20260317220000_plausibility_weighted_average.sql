-- ══════════════════════════════════════════════════════════════════════════════
-- Stage 5 Final: breweries.description → Brand Voice Context
--
-- Adds `description` to the equipmentProfile JSONB key.
-- The LEFT JOIN on breweries already exists → no extra query needed.
-- route.ts extracts it as `brandVoiceContext` and passes it to all
-- copywriter.* prompts so the AI writes in the brewery's own voice.
-- ══════════════════════════════════════════════════════════════════════════════
