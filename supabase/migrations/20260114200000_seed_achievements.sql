...
VALUES
    ...
    ('forum_voice', 'Forum Voice', 'Dein erster Beitrag im Forum.', '🗣️', 'social', 'bronze', 10, NOW()),
    ('forum_starter', 'Diskussionsleiter', '10 Themen im Forum gestartet.', '📝', 'social', 'silver', 25, NOW()),
    ('forum_pillar', 'Säule der Community', '50 Beiträge im Forum verfasst.', '🏛️', 'social', 'gold', 50, NOW()),
