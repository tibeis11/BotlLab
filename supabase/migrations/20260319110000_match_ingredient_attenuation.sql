-- Erweitert match_ingredient RPC um attenuation_pct.
--
-- Für Produkt-Level-Matches (1, 4): gibt ip.attenuation_pct des gematchten Produkts zurück.
-- Für Master-Level-Matches (2, 3, 5): berechnet den Durchschnitt aller Produkte dieses Masters.
--
-- Da sich der Return-Type ändert (neues Feld), muss die Funktion zuerst gedroppt werden.
